...
namespace Storage
{
    public class CalculatedFileProvider
    {
        ...
        public static string GetCalculatedMeanAverageFile(string currency, int meanAverageSize, string calculatedDataFolder) => Path.Combine(calculatedDataFolder, currency,$"{currency}_WMeanAverage_{meanAverageSize}_Calculated.csv");
    }
}